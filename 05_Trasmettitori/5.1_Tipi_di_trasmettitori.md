...
```mermaid
graph TD;
    Oscillatore["Oscillatore<br>🎵"] --> Modulatore["Modulatore<br>🔄"];
    Modulatore --> Amplificatore["Amplificatore<br>📈"];
    Amplificatore --> Filtro["Filtro<br>🎯"];
    Filtro --> Antenna["Antenna<br>📡"];
    classDef trasmettitore fill:#0cf,stroke:#333,stroke-width:2px;
    class Oscillatore,Modulatore,Amplificatore,Filtro,Antenna trasmettitore;
```
...
graph TD;
    ...
    AmplificatoreNonLineare --> GeneraArmoniche["Genera<br>Armoniche<br>2f, 3f, 4f...<br>🌊"];
    GeneraArmoniche --> FiltroPassaBanda["Filtro<br>Passa-Banda<br>🎯"];
    FiltroPassaBanda --> ArmonicaSelezionata["Armonica<br>Selezionata<br>n × f_base<br>📡"];
    ArmonicaSelezionata --> AmplificatoreFinale["Amplificatore<br>Finale<br>📈"];
    classDef mult fill:#f0f,stroke:#333,stroke-width:2px;
    class AmplificatoreNonLineare,GeneraArmoniche,FiltroPassaBanda mult;
```
