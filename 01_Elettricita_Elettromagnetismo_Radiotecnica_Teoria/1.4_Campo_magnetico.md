...
- **Formula**: B = (μ₀ × I) / (2π × r), dove B è l'induzione magnetica (in Tesla), μ₀ = 4π × 10⁻⁷ T·m/A (permeabilità del vuoto), r è la distanza dal conduttore.
...
graph TD;
    ...
    Note["Nota:<br>Regola della mano destra<br>B ∝ 1/r"];
```

Esempio: Per I = 10 A, r = 0.01 m, B = (4π × 10⁻⁷ × 10) / (2π × 0.01) ≈ 2 × 10⁻⁴ T.

### Grafico del Campo Magnetico
![Grafico Campo Magnetico](../images/grafico_campo_magnetico.png)
...
<details>
  ...
  <p>Induzione magnetica diminuisce con la distanza.</p>
</details>
